...
namespace wg::impl
{
    ...
    class diff_expr
    {
      ...
      public:
        ...
        friend constexpr auto get_blade(diff_expr<LHS, RHS> const& expr)
        {
            // Find which indices in sub expressions map to index I
            using index_map
                = wg::impl::sum_sub_indices<I, result_type,
...
namespace wg
{
    ...
    {
        return impl::diff_expr<LHS, RHS>(lhs, rhs);
    }
